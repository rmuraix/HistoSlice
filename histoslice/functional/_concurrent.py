...
# Set default start method to "spawn" for all Python versions.
# PyVips/libvips uses threads internally, and fork + threads can cause deadlocks.
# Using "spawn" avoids issues with thread-based libraries like libvips.
